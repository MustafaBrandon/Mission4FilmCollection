...
namespace FilmCollection.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Responses",
                columns: new[] { "FilmId", "CategoryId", "Edited", "FilmDirector", "FilmRating", "FilmTitle", "FilmYear", "LentTo", "Notes" },
                values: new object[] { 1, 1, false, "George Lucas", "PG", "Indiana Jones and the Raiders of the Lost Ark", 1981, "", "" });

            migrationBuilder.InsertData(
                table: "Responses",
                columns: new[] { "FilmId", "CategoryId", "Edited", "FilmDirector", "FilmRating", "FilmTitle", "FilmYear", "LentTo", "Notes" },
                values: new object[] { 2, 1, false, "Gore Verbinski", "PG-13", "Pirates of the Caribbean: The Curse of the Black Pearl", 2003, "", "" });

            migrationBuilder.InsertData(
                table: "Responses",
                columns: new[] { "FilmId", "CategoryId", "Edited", "FilmDirector", "FilmRating", "FilmTitle", "FilmYear", "LentTo", "Notes" },
                values: new object[] { 3, 2, false, "Kevin Reynolds", "PG-13", "The Count of Monte Cristo", 2002, "", "" });
